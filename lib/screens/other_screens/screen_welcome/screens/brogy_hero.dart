...
class BrogyHero extends StatefulWidget {
  ...
  const BrogyHero({super.key, this.tag});
...
class _BrogyHeroState extends State<BrogyHero> {
          ...
          return Stack(
              ...
              children: [
                ...
                fadeInOut(
                  ...
                  nextRouteName: WelcomeRoute.connectCloud.value,
                ),
                ...
                fadeInOut(
                  ...
                  previousRouteName: WelcomeRoute.connectCloud.value,
  ...
  Widget fadeInOut({
    ...
    if(newRoute == thisRoute && previousRoute == previousRouteName){
    ...
    if(newRoute == thisRoute && previousRoute == nextRouteName){
    ...
    if(nextRouteName == newRoute && previousRoute == thisRoute){
