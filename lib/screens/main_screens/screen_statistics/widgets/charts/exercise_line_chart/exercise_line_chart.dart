...
class _ExerciseLineChartState extends State<ExerciseLineChart> {
          ...
          SzWrapper(
            ...
            childBuilder: (context){
              return AspectRatio(
                ...
                child: LineChart(
                    duration: Duration(milliseconds: szController.animationTime),
  ...
  String getSpotData(LineBarSpot spot){
    ...
    // return "Test";
    final formattedDate = szController.spotDetailLevel == SpotDetailLevel.monthly? DateFormat("MMM yy") : DateFormat("d.MMM");
